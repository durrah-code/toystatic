              ...
              <tbody >
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <a href="admin-orderdetail.jsp?orderId=<%= rs.getString("id") %>"
class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1.5 px-3 rounded mr-2">Update</a>

                       <a href="#" onclick="confirmDelete(); return false;" class="remove-btn text-white font-bold py-2.5 px-4 rounded mr-2">
                           Padam
                       </a>

                                <form id="delete-form" action="orderController" method="post" style="display: none;">
                                    <input type="hidden" name="action" value="deleteorder">
                                    <input type="hidden" name="orderid" value="<%= rs.getString("id") %>">
                                </form>

                                <script>
                                function confirmDelete() {
                                    var confirmAction = confirm("Are you sure want to delete this order?");
